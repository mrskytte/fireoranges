...
function animateBulb() {
  //SET VALUE OF ANIMATIONELEMENT TO THE ANIMATION PATH/OBJECT YOU NEED TO USE
  animationElement =
    '<path class="yellow-bulb" class="st0" d="M572.1,240.1c-38.1,36.3-58,87.4-76.4,135.6"/>';
  ('<path class="blue-bulb" class="st1" d="M495.1,536.8c2.8,1.5,5.3,3.8,7.4,6.4c2.1,2.7,3.6,5.7,4.8,8.8c2.2,6.3,2.9,12.9,3.1,19.2s-0.3,12.5-0.4,18.5c-0.1,6-0.3,12,0.6,18.4c-4.1-5-6-11.6-7.1-17.9c-1.1-6.3-1.3-12.8-1.4-18.8c-0.1-6.2-0.3-12-1.1-17.8C500,548,498.3,542.4,495.1,536.8z"/>');
  ('<path class="blue-bulb" class="st1" d="M824.3,211.7c2.9,2.8,5.2,5.6,7.3,8.5c2.1,2.9,4.1,5.9,5.6,9.1c1.7,3.2,3.1,6.6,4.1,10.2c1,3.6,1.7,7.4,1.1,11.3c-2.8-2.8-5-5.6-7.1-8.5s-3.9-5.9-5.6-9.1c-1.7-3.2-3.1-6.6-4.2-10.1C824.6,219.4,823.9,215.8,824.3,211.7z"/>');
  ('<path class="blue-bulb" class="st1" d="M752.9,685.3c-1.4,3.1-3.2,5.6-5.3,7.7c-2.1,2.2-4.5,4.1-7.1,5.6c-2.7,1.5-5.6,2.7-8.8,3.1c-3.1,0.4-6.4,0.3-9.5-1c2.7-2.1,5-3.6,7.3-5.2c2.4-1.5,4.6-2.9,7-4.2c2.4-1.3,4.9-2.5,7.6-3.6S749.5,685.6,752.9,685.3z"/>');
  ...
  ('<path id="light_reflection_bulb_bottom" class="yellow-bulb" d="M684.9,723.8c81.5,31.9,11.2,63.9-53.8,63.9c-3.8,0-6.6,3.4-5.6,7c6.7,25.8,41.5,18.6,66.6,46.5"/>');
